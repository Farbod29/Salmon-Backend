...
@Properties({ 
	...
	@Property(
		name="api_key",//zzwfUKQbv4ykuaRwj4R8mwTnGbWeDwLF
		value="<api key here>",
		label="API Key",
...
public class OpenCalaisService implements CalaisService {
   ...
   // private String apiKey = ""; //  zzwfUKQbv4ykuaRwj4R8mwTnGbWeDwLF
	private String apiKey = "zzwfUKQbv4ykuaRwj4R8mwTnGbWeDwLF"; //  zzwfUKQbv4ykuaRwj4R8mwTnGbWeDwLF
